...
debugger.enter()
print '===> Loading model'
local model_filename = '/storage/product/det/torch_cache/inception6/stn_epoch28/model_31.t7'
...
for k, fname in ipairs(image_list) do
  ...
  fname = '/works/imagenet-mulitGPU/img/1171563108_B_V.jpg'
