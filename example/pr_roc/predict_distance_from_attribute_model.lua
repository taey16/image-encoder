...
local metric = 'L2'
local model_path = 
  '/storage/attribute/checkpoints/tshirts_shirts_blous_knit_84883_6400_seq_length-1/_resception_bn_removed_epoch19_bs16_flipfalse_croptrue_lstm_tanh_hidden384_layer2_dropout0.5_lr1.000000e-03_anneal_seed0.94_start53050_every5305_finetune0_cnnlr1.000000e-03_cnnwc1.000000e-05'
local model_filename = 
  paths.concat(model_path, 'model_id_resception_bn_removed_epoch19_bs16_flipfalse_croptrue_lstm_tanh_hidden384_layer2_dropout0.5_lr1.000000e-03_anneal_seed0.94_start53050_every5305_finetune0_cnnlr1.000000e-03_cnnwc1.000000e-05.t7')
print(string.format('===> Loading model: %s', model_filename))
local checkpoint_proto = torch.load(model_filename)
local model = checkpoint_proto.protos.cnn
if metric == 'L2' then
