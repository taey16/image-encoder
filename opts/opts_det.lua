...
function M.parse(arg)
  local defaultDir= paths.concat('/data2/product/det/')
  ...
  local retrain_path = '/data2/product/det/torch_cache/inception6/det_stnThuDec316:19:512015/'
  if retrain_path then
    initial_model = paths.concat(retrain_path, 'model_11.t7') 
    initial_optimState = paths.concat(retrain_path, 'optimState_11.t7')
  ...
  cmd:option('-use_stn', false, 'wether to use spatial transformer or not')
