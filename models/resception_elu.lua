...
function createModel()
  ...
  add_concat_flow:add(nn.ELU(1.0, true))
  ...
  feature_main_flow_1:add(nn.ELU(1.0, true))
  -- 73
  ...
  add_concat_flow_1:add(nn.ELU(1.0, true))
  feature:add(add_concat_flow_1)
  -- 71
  feature:add(cudnn.SpatialMaxPooling(3, 3, 2, 2, 0, 0))
  -- floor( 71 / 2 ) = 35

  mixed_1 = resception_elu_module( 1, 192, {{64 }, { 48,  64},{64, 96, 96}, {32}})
  -- 192 + 64 + 64 + 96 + 32 = 256 (similar to fig.4,5)
  mixed_2 = resception_elu_module( 2, 256, {{64 }, { 48,  64},{64, 96, 96}, {64}})
  mixed_3 = resception_elu_module( 3, 288, {{64 }, { 48,  64},{64, 96, 96}, {64}})
  -- similar to fig.10
  mixed_4 = resception_elu_module( 4, 288, {{384}, { 64,  96,  96}})

  -- floor( 35 / 2 ) = 17
  -- 288 + 384 + 96 = 768 (fig.6)
  mixed_5 = resception_elu_module( 5, 768, {{192}, {128, 128, 192}, {128, 128, 128, 128, 192}, {192}})
  mixed_6 = resception_elu_module( 6, 768, {{192}, {160, 160, 192}, {160, 160, 160, 160, 192}, {192}})
  mixed_7 = resception_elu_module( 7, 768, {{192}, {160, 160, 192}, {160, 160, 160, 160, 192}, {192}})
  mixed_8 = resception_elu_module( 8, 768, {{192}, {192, 192, 192}, {192, 192, 192, 192, 192}, {192}})
  -- similar to fig.10
  mixed_9 = resception_elu_module( 9, 768, {{192, 320}, {192, 192, 192, 192}})

  -- floor(17 / 2) = 8
  -- 768 + 320 + 192 = 1280 (fig.7)
  mixed_10= resception_elu_module(10,1280, {{320}, {384, 384, 384}, {448, 384, 384, 384}, {192}})
  -- 320 + (384 + 384) + (384 + 384) + 192 = 2048  (fig.7)
  mixed_11= resception_elu_module(11,2048, {{320}, {384, 384, 384}, {448, 384, 384, 384}, {192}})
