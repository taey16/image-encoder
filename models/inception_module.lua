...
function resception_module(mixed_id, input_size, config)
  ...
  if layer_id == 1 or layer_id == 2 or layer_id == 3 then
    ...
    --mixed_tower_conv:add(cudnn.ReLU(true))
    local shrotcut_mixed_tower_conv = nn.Sequential()
    shortcut_mixed_tower_conv:add(cudnn.SpatialConvolution(input_size, config[2][2], 3, 3, 1, 1, 1, 1))
    shortcut_mixed_tower_conv:add(nn.SpatialBatchNormalization(config[2][2], std_epsilon, nil, true))
    ...
    --mixed_tower_1_conv:add(cudnn.ReLU(true))
    local shortcut_tower_1_conv = nn.Sequential()
    shortcut_mixed_tower_1_conv:add(cudnn.SpatialConvolution(input_size, config[3][3], 1, 1, 1, 1, 1, 1))
    shortcut_mixed_tower_1_conv:add(nn.SpatialBatchNormalization(config[3][3], std_epsilon, nil, true))
  ...
  elseif layer_id == 4 then
    ...
    shortcut_mixed_tower_1_conv:add(cudnn.SpatialBatchNormalization(input_size, config[2][3], 3, 3, 2, 2, 0, 0))
    shortcut_mixed_tower_1_conv:add(nn.SpatialBatchNormalization(config[2][3], std_epsilon, nil, true))
    local concat_mixed_tower_1_conv = nn.ConcatTable()
    concat_mixed_tower_1_conv:add(mixed_tower_1_conv)
    concat_mixed_tower_1_conv:add(shortcut_mixed_tower_1_conv)
    local add_concat_mixed_tower_1_conv = nn.Sequential()
  ...
  elseif layer_id == 5 or layer_id == 6 or layer_id == 7 or layer_id == 8 then
    ...
    shortcut_mixed_tower_conv:add(nn.SpatialBatchNormalization(config[2][3], std_epsilon, nil, true))
    local concat_mixed_tower_conv = nn.ConcatTable()
    concat_mixed_tower_conv:add(mixed_tower_conv)
    concat_mixed_tower_conv:add(shortcut_mixed_tower_conv)
    local add_concat_mixed_tower_conv = nn.Sequential()
    ...
    --mixed_tower_1_conv:add(cudnn.ReLU(true))
    local shortcut_mixed_tower_1_conv = nn.Sequential()
    shortcut_mixed_tower_1_conv:add(cudnn.SpatialBatchNormalization(input_size, config[3][5], 1, 1, 1, 1, 0, 0))
    shortcut_mixed_tower_1_conv:add(nn.SpatialBatchNormalization(config[3][5], std_epsilon, nil, true))
    local concat_mixed_tower_1_conv = nn.ConcatTable()
    concat_mixed_tower_1_conv:add(mixed_tower_1_conv)
    concat_mixed_tower_1_conv:add(shortcut_mixed_tower_1_conv)
    local add_concat_mixed_tower_1_conv = nn.Sequential()
  ...
  elseif layer_id == 9 then
    ...
    shortcut_mixed_conv:add(nn.SpatialBatchNormalization(config[1][2], std_epsilon, nil, true))
    ...
    --mixed_tower_conv:add(cudnn.ReLU(true))
    local shortcut_mixed_tower_conv = nn.Sequential()
    shortcut_mixed_tower_conv:add(cudnn.SpatialBatchNormalization(input_size, config[2][4], 3, 3, 2, 2, 0, 0))
    shortcut_mixed_tower_conv:add(nn.SpatialBatchNormalization(config[2][4], std_epsilon, nil, true))
    local concat_mixed_tower_conv = nn.ConcatTable()
    concat_mixed_tower_conv:add(mixed_tower_conv)
    concat_mixed_tower_conv:add(shortcut_mixed_tower_conv)
    local add_concat_mixed_tower_conv = nn.Sequential()
  ...
  elseif layer_id == 10 or layer_id == 11 then
    ...
    shortcut_mixed_tower_conv:add(nn.SpatialBatchNormalization(config[2][2]+config[2][3], std_epsilon, nil, true))
    local concat_mixed_tower_conv = nn.ConcatTable()
    concat_mixed_tower_conv:add(mixed_tower_conv)
    concat_mixed_tower_conv:add(shortcut_mixed_tower_conv)
    local add_concat_mixed_tower_conv = nn.Sequential()
    ...
    local shortcut_mixed_1_conv = nn.Sequential()
    shortcut_mixed_1_conv:add(cudnn.SpatialConvolution(input_size, config[3][3]+config[3][4], 1, 1, 1, 1, 0, 0))
    shortcut_mixed_1_conv:add(nn.SpatialBatchNormalization(config[3][3]+config[3][4], std_epsilon, nil, true))
    local concat_mixed_tower_1_conv = nn.ConcatTable()
    concat_mixed_tower_1_conv:add(mixed_tower_1_conv)
    concat_mixed_tower_1_conv:add(shortcut_mixed_tower_1_conv)
    local add_concat_mixed_tower_1_conv = nn.Sequential()
